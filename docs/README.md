...
| [`literatura/`](literatura/README.md) | **Biblioteca de contexto** dos artigos de referência: um dossiê por PDF (`Artigos-Referencia/`) — a linhagem própria do método (NMFSt.P → FPMax → Exploring Evolutionary Patterns → PhyloTreeMiner/grafos) e os baselines externos (Li *et al.* 2007, Zadra *et al.* 2024). | Raramente — só quando um artigo novo entra |
