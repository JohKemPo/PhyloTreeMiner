...
| # | O quê | Onde |
|---|---|---|
| 1 | A aquisição não baixa RefSeq e GenBank do mesmo genoma: **decidido (DEC-082) — preferir RefSeq**, relabelando na posição em que a deduplicação já mantém o sobrevivente hoje | `workflow_dataAcquisition.py` — é o [M2.1](../automation/10-marcos-e-metas.md) |
