...
// Estado de servidor (Arq-C/M5): cache e refetch de `useQuery` compartilhados
// pela árvore inteira, em vez de cada componente reimplementar seu próprio
// par fetch+useState (era daí que vinha boa parte dos 62 `useEffect` manuais).
